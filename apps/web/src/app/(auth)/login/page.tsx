    ...
    <div className="flex flex-col gap-1.5">
      ...
      <div className="relative">
        ...
        <input
          ...
          className={`w-full rounded-lg border bg-[#0f1419] py-2.5 pl-9 pr-${rightSlot ? "10" : "4"} text-sm text-gray-100 placeholder-gray-600 outline-none transition-colors focus:ring-2 ${
            error
...
export default function LoginPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      setErrors({ form: "Invalid email or password." }); // demo error
    } finally {
      setLoading(false);
    }
  }
